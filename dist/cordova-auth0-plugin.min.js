...
!(function (global, factory) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(factory)
    : ((global = global || self).CordovaAuth0Plugin = factory());
})(this, function () {
  'use strict';
  var version_raw = '9.19.0',
  ...
  var n,
    ...
    INTRINSICS = {
      ...
      '%MapIteratorPrototype%':
        'undefined' != typeof Map && hasSymbols$1 ? getProto(new Map()[Symbol.iterator]()) : void 0,
      '%Math%': Math,
      '%Number%': Number,
      '%Object%': Object,
      ...
      '%SetIteratorPrototype%':
        'undefined' != typeof Set && hasSymbols$1 ? getProto(new Set()[Symbol.iterator]()) : void 0,
    ...
    getBaseIntrinsic = function (name, allowMissing) {
      var alias,
        intrinsicName = name;
      if (
        (src(LEGACY_ALIASES, intrinsicName) &&
      ...
      for (var i = 1, isOwn = !0; i < parts.length; i += 1) {
        ...
        if (
          ...
          if ($gOPD && i + 1 >= parts.length) {
            ...
            value =
              (isOwn = !!desc) && 'get' in desc && !('originalValue' in desc.get)
                ? desc.get
                : value[part];
    ...
    callBound = function (name, allowMissing) {
      ...
      return 'function' == typeof intrinsic && $indexOf(name, '.prototype.') > -1
        ? callBind(intrinsic)
        : intrinsic;
    },
    require$$0 = ((n = Object.freeze({ __proto__: null, default: {} })) && n.default) || n,
    ...
    toStringTag =
      'function' == typeof Symbol && void 0 !== Symbol.toStringTag ? Symbol.toStringTag : null,
    objectInspect = function inspect_(obj, options, depth, seen) {
      ...
      if (
        !(function (obj) {
          return !(
            '[object Date]' !== toStr$1(obj) ||
            (toStringTag && 'object' == typeof obj && toStringTag in obj)
          );
        })(obj) &&
        !(function (obj) {
          return !(
            '[object RegExp]' !== toStr$1(obj) ||
            (toStringTag && 'object' == typeof obj && toStringTag in obj)
          );
        })(obj)
      ) {
  ...
  function collectionOf(type, size, entries, indent) {
    return (
      ...
      size +
      ') {' +
      (indent ? indentedJoin(entries, indent) : entries.join(', ')) +
      '}'
    );
  }
  ...
  var $TypeError$1 = getIntrinsic('%TypeError%'),
    ...
    utils = {
      ...
      merge: function merge(target, source, options) {
        ...
        return (
          isArray$2(target) && !isArray$2(source) && (mergeTarget = arrayToObject(target, options)),
          isArray$2(target) && isArray$2(source)
    ...
    stringify = function stringify(
      ...
      if ('comma' === generateArrayPrefix && isArray$3(obj))
        objKeys = [{ value: obj.length > 0 ? obj.join(',') || null : void 0 }];
      else if (isArray$3(filter)) objKeys = filter;
      else {
      ...
      function (object, opts) {
        var objKeys,
          ...
          options = (function (opts) {
            ...
            return (
              ('function' == typeof opts.filter || isArray$3(opts.filter)) &&
                (filter = opts.filter),
              {
                addQueryPrefix:
        ...
        'function' == typeof options.filter
          ...
          : isArray$3(options.filter) && (objKeys = options.filter);
        var arrayFormat,
          keys = [];
  ...
  return (
    (PopupHandler.prototype.preload = function (options) {
      ...
      var windowFeatures = lib_stringify(popupOptions, { encode: !1, delimiter: ',' });
      return (
    ...
    (PopupHandler.prototype.load = function (url, _, options, cb) {
      ...
      (this.url = url),
        ...
        this._current_popup
          ...
          : ((options.url = url), this.preload(options)),
      ...
      if (this._current_popup) {
        ...
        if (!event.url || 0 === event.url.indexOf(callbackUrl + '#')) {
          ...
          if (1 !== parts.length) {
            ...
            this.options.nonce && (opts.nonce = this.options.nonce),
